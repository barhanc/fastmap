...
if __name__ == "__main__":
    ...
    # ]
    # nv, nc = 11, 11
    # culture1 = APPROVAL_CULTURES[-1]  # random.randint(0, len(APPROVAL_CULTURES) - 1)]
    # culture2 = APPROVAL_CULTURES[-1]  # random.randint(0, len(APPROVAL_CULTURES) - 1)]
    ...
    # t3 = time.monotonic()
    # d3 = fastmap.hamming(oU, oV, method="aa", repeats=300)
    # t3 = time.monotonic() - t3
