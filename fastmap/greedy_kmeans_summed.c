...
static PyObject* py_greedy_kmeans_summed(PyObject* self, PyObject* args) {
    PyObject* votes_obj;
    ...
    double result = greedy_kmeans_summed(votes, num_voters, num_candidates);
...
static PyMethodDef methods[] = {
    { "greedy_kmeans_summed", (PyCFunction)py_greedy_kmeans_summed, METH_VARARGS, "Greedy K-means summed calculation" },
    { NULL, NULL, 0, NULL }
};

static struct PyModuleDef moduledef = {
    PyModuleDef_HEAD_INIT, "_greedy_kmeans_summed", "Greedy K-means module", -1, methods,
    NULL, NULL, NULL, NULL
};

PyMODINIT_FUNC PyInit__greedy_kmeans_summed(void) {
    import_array();
