...
static inline void calculate_vote_swap_dist(int **votes, int votes_num, int **distances, int n) {
...
static inline double *local_search_kKemeny(int **votes, int num_voters, int num_candidates, int l, int *starting) {
